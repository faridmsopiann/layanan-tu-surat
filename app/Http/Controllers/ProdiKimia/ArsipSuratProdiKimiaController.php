...
class ArsipSuratProdiKimiaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('prodi-kimia.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('prodi-kimia.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
