...
class ArsipSuratProdiAgribisnisController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Proposal::with(['pemohon', 'modalDisposisi'])
            ...
            ->whereHas('modalDisposisi', function ($q) {
                $q->where('tujuan', 'Prodi Agribisnis');
            })->withTrashed();
        ...
        return view('prodi-agribisnis.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('prodi-agribisnis.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
