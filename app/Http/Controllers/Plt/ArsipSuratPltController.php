...
class ArsipSuratPltController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('plt.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('plt.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
