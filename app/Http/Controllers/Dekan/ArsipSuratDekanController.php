...
class ArsipSuratDekanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dekan.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('dekan.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
