...
class ArsipSuratProdiTPController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Proposal::with(['pemohon', 'modalDisposisi'])
            ...
            ->whereHas('modalDisposisi', function ($q) {
                $q->where('tujuan', 'Prodi Teknik Pertambangan');
            })->withTrashed();
        ...
        return view('prodi-tp.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('prodi-teknik-pertambangan.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
