...
class ArsipSuratPerpusController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('perpus.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('perpus.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
