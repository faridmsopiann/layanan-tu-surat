...
class ArsipSuratAkademikController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('akademik.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('akademik.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
