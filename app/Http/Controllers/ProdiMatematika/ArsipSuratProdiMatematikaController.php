...
class ArsipSuratProdiMatematikaController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Proposal::with(['pemohon', 'modalDisposisi'])
            ...
            ->whereHas('modalDisposisi', function ($q) {
                $q->where('tujuan', 'Prodi Matematika');
            })->withTrashed();
        ...
        return view('prodi-matematika.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('prodi-matematika.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
