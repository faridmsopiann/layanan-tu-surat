...
class ArsipSuratUmumController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('umum.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('umum.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
