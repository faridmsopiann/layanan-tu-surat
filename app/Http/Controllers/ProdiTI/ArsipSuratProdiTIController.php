...
class ArsipSuratProdiTIController extends Controller
{
    public function index(Request $request)
    {
        ...
        $query = Proposal::with(['pemohon', 'modalDisposisi'])
            ...
            ->whereHas('modalDisposisi', function ($q) {
                $q->where('tujuan', 'Prodi Teknik Informatika');
            })->withTrashed();
        ...
        return view('prodi-ti.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('prodi-teknik-informatika.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
