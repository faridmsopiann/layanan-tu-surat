...
class ArsipSuratProdiBiologiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('prodi-biologi.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('prodi-biologi.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
