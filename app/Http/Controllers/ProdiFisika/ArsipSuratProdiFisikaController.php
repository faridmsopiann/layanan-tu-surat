...
class ArsipSuratProdiFisikaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('prodi-fisika.arsip.index', compact('arsipProposals'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('prodi-fisika.arsip.index')->with('success', 'Proposal berhasil dihapus.');
    }
}
