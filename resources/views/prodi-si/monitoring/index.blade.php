                                ...
                                <div class="modal-content shadow-sm">
                                    ...
                                    <div class="modal-footer">
                                                @if ($proposal->status_disposisi == 'Selesai' && $proposal->jenis_proposal === 'Surat Masuk')
                                                    <a href="{{ route('prodi-sistem-informasi.proposals.pdf', $proposal->id) }}" target="_blank" class="btn btn-primary">
                                                        <i class="fas fa-print"></i> Cetak PDF
                                                    </a>
                                                    <a href="{{ route('prodi-sistem-informasi.proposals.word', $proposal->id) }}" class="btn btn-info" target="_blank">
                                                        <i class="fas fa-file-word"></i> Cetak Word
                                                    </a>
                                                @elseif ($proposal->status_disposisi == 'Selesai' && $proposal->jenis_proposal === 'Surat Tugas')
                                                    <a href="{{ route('prodi-sistem-informasi.surat-tugas.pdf', $proposal->id) }}" target="_blank" class="btn btn-primary">
                                                        <i class="fas fa-print"></i> Cetak PDF
                                                    </a>
                                                    <a href="{{ route('prodi-sistem-informasi.surat-tugas.word', $proposal->id) }}" class="btn btn-info" target="_blank">
                                                        <i class="fas fa-file-word"></i> Cetak Word
                                                    </a>
                                                @endif
