...
<div class="container pb-4 mb-4" style="font-family: 'Roboto', sans-serif;">
    ...
    @if($arsipProposals->isEmpty())
        <form method="GET" action="{{ route('prodi-biologi.arsip.index') }}" class="p-2 rounded shadow-sm bg-info">
            ...
            <a href="{{ route('prodi-biologi.arsip.index') }}" class="btn btn-secondary btn-sm mr-1">
                    ...
                    @foreach($arsipProposals as $key => $proposal)
                        <tr class="align-middle" style="transition: background-color 0.3s;">
                            ...
                            <td class="d-flex">
                                        ...
                                        <div class="modal-content shadow-sm">
                                            ...
                                            <div class="modal-footer">
                                                @if ($proposal->status_disposisi == 'Selesai' && $proposal->jenis_proposal === 'Surat Masuk')
                                                    <a href="{{ route('prodi-biologi.proposals.pdf', $proposal->id) }}" target="_blank" class="btn btn-primary">
                                                        <i class="fas fa-print"></i> Cetak PDF
                                                    </a>
                                                    <a href="{{ route('prodi-biologi.proposals.word', $proposal->id) }}" class="btn btn-info" target="_blank">
                                                        <i class="fas fa-file-word"></i> Cetak Word
                                                    </a>
                                                @elseif ($proposal->status_disposisi == 'Selesai' && $proposal->jenis_proposal === 'Surat Tugas')
                                                    <a href="{{ route('prodi-biologi.surat-tugas.pdf', $proposal->id) }}" target="_blank" class="btn btn-primary">
                                                        <i class="fas fa-print"></i> Cetak PDF
                                                    </a>
                                                    <a href="{{ route('prodi-biologi.surat-tugas.word', $proposal->id) }}" class="btn btn-info" target="_blank">
                                                        <i class="fas fa-file-word"></i> Cetak Word
                                                    </a>
                                                @endif
                                ...
                                <!-- Delete Button -->
                                <form action="{{ route('prodi-biologi.arsip.destroy', $proposal->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
