...
<div class="container pb-4 mb-4" style="font-family: 'Roboto', sans-serif;">
    ...
    @if($arsipProposals->isEmpty())
        <form method="GET" action="{{ route('prodi-teknik-informatika.arsip.index') }}" class="p-2 rounded shadow-sm bg-info">
            ...
            <a href="{{ route('prodi-teknik-informatika.arsip.index') }}" class="btn btn-secondary btn-sm mr-1">
                    ...
                    @foreach($arsipProposals as $key => $proposal)
                        <tr class="align-middle" style="transition: background-color 0.3s;">
                            ...
                            <td class="d-flex">
                                ...
                                <!-- Delete Button -->
                                <form action="{{ route('prodi-teknik-informatika.arsip.destroy', $proposal->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
