    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('umum.dashboard') }}" class="brand-link logo-switch">
                ...
                <li class="nav-item">
                    <a href="{{ route('umum.dashboard') }}" class="nav-link {{ Request::routeIs('umum.dashboard') ? 'active' : '' }} mt-2">
                ...
                <!-- Disposisi Menu Item -->
                <li class="nav-item">
                    <a href="{{ route('umum.disposisi.index') }}" class="nav-link {{ Request::routeIs('umum.disposisi.index') ? 'active' : '' }}">
