@extends('prodi-agribisnis.layouts.app')
...
<div class="container pb-4 mb-4" style="font-family: 'Roboto', sans-serif;">
    ...
    @if($arsipProposals->isEmpty())
        <form method="GET" action="{{ route('prodi-agribisnis.arsip.index') }}" class="p-2 rounded shadow-sm bg-info">
            ...
            <a href="{{ route('prodi-agribisnis.arsip.index') }}" class="btn btn-secondary btn-sm mr-1">
                    ...
                    @foreach($arsipProposals as $key => $proposal)
                        <tr class="align-middle" style="transition: background-color 0.3s;">
                            ...
                            <td class="text-sm">
                                @if ($proposal->soft_file)
                                    ...
                                    @elseif (count($files) > 1)
                                        <div class="mt-0">
                                            <a href="{{ route('prodi-agribisnis.proposals.downloadZip', $proposal->id) }}" class="btn-sm btn-info" style="white-space: nowrap;">
                            ...
                            <td class="d-flex">
                                        ...
                                        <div class="modal-content shadow-sm">
                                            ...
                                            <div class="modal-footer">
                                                @if ($proposal->status_disposisi == 'Selesai' && $proposal->jenis_proposal === 'Surat Masuk')
                                                    <a href="{{ route('prodi-agribisnis.proposals.pdf', $proposal->id) }}" target="_blank" class="btn btn-primary">
                                                        <i class="fas fa-print"></i> Cetak PDF
                                                    </a>
                                                    <a href="{{ route('prodi-agribisnis.proposals.word', $proposal->id) }}" class="btn btn-info" target="_blank">
                                                        <i class="fas fa-file-word"></i> Cetak Word
                                                    </a>
                                                @elseif ($proposal->status_disposisi == 'Selesai' && $proposal->jenis_proposal === 'Surat Tugas')
                                                    <a href="{{ route('prodi-agribisnis.surat-tugas.pdf', $proposal->id) }}" target="_blank" class="btn btn-primary">
                                                        <i class="fas fa-print"></i> Cetak PDF
                                                    </a>
                                                    <a href="{{ route('prodi-agribisnis.surat-tugas.word', $proposal->id) }}" class="btn btn-info" target="_blank">
                                                        <i class="fas fa-file-word"></i> Cetak Word
                                                    </a>
                                                @endif
                                ...
                                <!-- Delete Button -->
                                <form action="{{ route('prodi-agribisnis.arsip.destroy', $proposal->id) }}" method="POST" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
