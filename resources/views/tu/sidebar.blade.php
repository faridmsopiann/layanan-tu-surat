    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('tu.dashboard') }}" class="brand-link logo-switch" style="display: flex; align-items: center;">
                ...
                <li class="nav-item">
                    <a href="{{ route('tu.dashboard') }}" class="nav-link {{ Request::routeIs('tu.dashboard') ? 'active' : '' }} mt-2">
                ...
                <!-- Proposal Masuk -->
                {{-- <li class="nav-item">
                    <a href="{{ route('tu.proposals.index') }}" class="nav-link">
                ...
                <!-- Pengajuan -->
                <li class="nav-item">
                    <a href="{{ route('tu.proposals.indexpengajuan') }}" class="nav-link {{ Request::routeIs('tu.proposals.indexpengajuan') ? 'active' : '' }}">
                ...
                <!-- Disposisi Menu Item -->
                <li class="nav-item">
                    <a href="{{ route('tu.disposisi.index') }}" class="nav-link {{ Request::routeIs('tu.disposisi.index') ? 'active' : '' }}">
