    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="{{ route('plt.dashboard') }}" class="brand-link logo-switch" style="display: flex; align-items: center;">
                ...
                <li class="nav-item">
                    <a href="{{ route('akademik.dashboard') }}" class="nav-link {{ Request::routeIs('akademik.dashboard') ? 'active' : '' }} mt-2">
                ...
                <!-- Disposisi Menu Item -->
                <li class="nav-item">
                    <a href="{{ route('akademik.disposisi.index') }}" class="nav-link {{ Request::routeIs('akademik.disposisi.index') ? 'active' : '' }}">
