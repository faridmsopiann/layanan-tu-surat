...
<div class="container pt-4" style="font-family: 'Roboto', sans-serif;">
    <h2 style="font-weight: 700; color: #2C3E50;">Manajemen Instansi</h2>
                ...
                @foreach($data as $item)
                    <tr class="align-middle">
                        ...
                        <td class="d-flex justify-content-center">
                            ...
                            <form action="{{ route('admin.instansi.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')">
                                @csrf @method('DELETE')
                    ...
                    <div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <form action="{{ route('admin.instansi.update', $item->id) }}" method="POST">
                                @csrf @method('PUT')
