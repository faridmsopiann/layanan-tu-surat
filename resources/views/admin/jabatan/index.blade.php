...
<div class="container pt-4" style="font-family: 'Roboto', sans-serif;">
    <h2 style="font-weight: 700; color: #2C3E50;">Manajemen Jabatan</h2>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="d-flex justify-content-center">
                        ...
                        <!-- Tombol Hapus -->
                        <form action="{{ route('admin.jabatan.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus?')">
                            @csrf @method('DELETE')
